	      ...
	      <td width="60" align="center" valign="middle" class="TOPSTYLE"><span onclick="_logout();" style="cursor:hand" class="TOPSTYLE">退出系统</span></td>
            ...
            <tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                	<tr>
                    	<td>&nbsp;</td>
                        <td width="110" height="25" align="right" background="/images/system_bg.gif" style="background-repeat:no-repeat"><a href="/cms/cms/website/RSJ/znbm/index.jsp?siteId=13" target="_blank" style="text-decoration:none"><span class="SYSSTYLE">人事管理系统&nbsp;</span></a></td>
                        <td width="5"></td>
                    </tr>
                </table>
                </td>
