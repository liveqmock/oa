 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class OrgInfoTreeServlet extends ServletBase {
	/* (non-Javadoc)
	...
	protected void performTask(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ConnLog.open("OrgInfoTreeServlet");
			...
			this.forward(request, response, "/orgtree/orgInfoTree.jsp");
			...
			try {
				if (conn != null) {
					conn.close();
					ConnLog.close("OrgInfoTreeServlet");
				}
			} catch (SQLException sqle) {
			}
		}
