...
public class PhoneInfoSysPersonSearchDAO extends SearchDAO {
	...
	protected void setupFields() throws DAOException {
		...
		addField("noteid", "HRPERSON.NOTEID");
		addField("orguuid", "HRPERSON.ORGUUID");
		addField("useruuid", "HRPERSON.USERUUID");
		addField("username", "HRPERSON.USERNAME");
		addField("officephone", "HRPERSON.OFFICEPHONE");
		addField("homephone", "HRPERSON.HOMEPHONE");
		addField("netphone", "HRPERSON.NETPHONE");
		addField("mobilephone", "HRPERSON.MOBILEPHONE");
		addField("faxphone", "HRPERSON.FAXPHONE");
		addField("officeaddress", "HRPERSON.OFFICEADDRESS");
		addField("function", "HRPERSON.FUNCTION");
		addField("ispermission", "HRPERSON.ISPERMISSION");
		addField("maintanperson", "HRPERSON.MAINTANPERSON");
		addField("lastmaintantime", "HRPERSON.LASTMAINTANTIME");
		addField("noteorder", "HRPERSON.NOTEORDER");
		addField("nameids", "HRPERSON.NAMEIDS");
		addField("isparttime", "PHONE_INFO.ISPARTTIME");
