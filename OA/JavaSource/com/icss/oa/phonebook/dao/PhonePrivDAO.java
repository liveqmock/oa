 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class PhonePrivDAO extends DAO {
	...
	protected void setupFields() throws DAOException {
		...
		addField("pp_type", "PP_TYPE");
		addField("pp_scope", "PP_SCOPE");
		addField("pp_name", "PP_NAME");
		addField("pp_level", "PP_LEVEL");
		addField("pp_searchlevel", "PP_SEARCHLEVEL");
		
		setTableName("PHONE_PRIVILEDGE");          
		addKey("PP_ID");
		this.setAutoIncremented("PP_ID");
	}

	public PhonePrivDAO(Connection conn) {
		super(conn);
	}
