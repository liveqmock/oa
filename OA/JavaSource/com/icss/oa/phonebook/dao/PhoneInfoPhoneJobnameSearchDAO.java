 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class PhoneInfoPhoneJobnameSearchDAO extends SearchDAO {
	...
	protected void setupFields() throws DAOException {
		...
		addField("nameid", "PHONE_JOBNAME.NAMEID");
		addField("name", "PHONE_JOBNAME.NAME");
		addField("jobid", "PHONE_JOBNAME.JOBID");
	}
	...
	public PhoneInfoPhoneJobnameSearchDAO() {
		super();
	}
}
