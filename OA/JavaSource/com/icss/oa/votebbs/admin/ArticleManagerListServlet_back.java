 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ArticleManagerListServlet_back extends ServletBase{
	...
	protected void performTask(HttpServletRequest request, HttpServletResponse response) 
		...
		String uuid=request.getParameter("uuid")==null?"-1":request.getParameter("uuid").toString();
		String userid=request.getParameter("userid")==null?"-1":request.getParameter("userid").toString();
		String userenname=request.getParameter("userenname")==null?"-1":request.getParameter("userenname").toString();
