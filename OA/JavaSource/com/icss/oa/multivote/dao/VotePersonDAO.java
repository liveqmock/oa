...
public class VotePersonDAO extends DAO {
	...
	public void setFirstflag(String _firstflag) {
		firePropertyChange("firstflag", firstflag, _firstflag);
	...
	protected void setupFields() throws DAOException {
		...
		setTableName("VOTE_PERSON");
		addKey("PERSON_ID");
		setAutoIncremented("PERSON_ID");
	}

	public VotePersonDAO(Connection conn) {
		super(conn);
	}

	public VotePersonDAO() {
		super();
	}
