...
public class ShowScheduleServlet extends ServletBase {
	...
	protected void performTask(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ConnLog.open("ShowScheduleServlet");
			...
			this.forward(request, response, "/netoffice/schedule/addMeeting.jsp?direct=calMain");
			...
			try {
				if (conn != null) {
					conn.close();
					ConnLog.close("ShowScheduleServlet");
				}
