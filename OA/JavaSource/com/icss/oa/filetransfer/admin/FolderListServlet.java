...
/**
 * Servlet implementation class for Servlet: FolderListServlet
 *
 */
 public class FolderListServlet extends com.icss.j2ee.servlet.ServletBase implements javax.servlet.Servlet {
		...
		protected void performTask(
				...
				try {
					...
					ip = PropertyManager.getProperty("archivesip");
					...
					this.forward(request, response, "/mail/Mail_Left.jsp");
				} catch (Exception ex) {
					ex.printStackTrace();
