 ...
 * 建立转发邮件
 */
public class BuildTransmitServlet extends ServletBase {
	...
	protected void performTask(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			sendFileBean.setContent("&nbsp;&nbsp;&nbsp;&nbsp;------------------------文件源信息------------------------&nbsp;&nbsp;&nbsp;&nbsp;<br><br>" + request.getParameter("content") + "<br><br>&nbsp;&nbsp;&nbsp;&nbsp;--------------------------------------------------------&nbsp;&nbsp;&nbsp;&nbsp;<br><br>");
			...
			this.forward(request, response, "/filetransfer/transmitAfterModify.jsp");
