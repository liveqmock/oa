...
public class BbsArticleDelVO extends ValueObject {
	...
	public void setShowsign(String _showsign) {
		showsign = _showsign;
	}
	public String getDelpersonuuid() {
		return delpersonuuid;
	}
	public void setDelpersonuuid(String delpersonuuid) {
		this.delpersonuuid = delpersonuuid;
	}
