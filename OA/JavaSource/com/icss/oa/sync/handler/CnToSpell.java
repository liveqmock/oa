...
public class CnToSpell {
	...
	public static String getFullSpell2(String cnStr)
	{
		...
		for (int i = 0, Len = chars.length; i < Len; i++) {
			...
			if(i==0 && "褚盖乐区单仇朴翟查秘解折".indexOf(String.valueOf(chars[0]))>-1){
				//String a = String.valueOf(chars[0]);
				switch(chars[0]){
				case '褚' : retuBuf.append("chu"); break;
				case '盖' : retuBuf.append("ge"); break;
				case '乐' : retuBuf.append("yue"); break;
				case '区' : retuBuf.append("ou"); break;
				case '单' : retuBuf.append("shan"); break;
				case '仇' : retuBuf.append("qiu"); break;
				case '朴' : retuBuf.append("piao"); break;
				case '翟' : retuBuf.append("zhai"); break;
				case '查' : retuBuf.append("zha"); break;
				case '秘' : retuBuf.append("bi"); break;
				case '解' : retuBuf.append("xie"); break;
				case '折' : retuBuf.append("she"); break;
	...
	public static void main(String[] args) {
		...
		String str = null;
		str = "折区盖单军";
		System.out.println("Spell=" + CnToSpell.getFullSpell2(str));
		Date end = new Date();
