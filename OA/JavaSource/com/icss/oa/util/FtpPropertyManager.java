...
public class FtpPropertyManager {
	...
	private static FtpPropertyManager manager = null;
	private static Object managerLock = new Object();
	private static String propsName = "/WEB-INF/ftp.properties";
	...
	/**
	 * Creates a new FtpPropertyManager. Singleton access only.
	 */
	
	private FtpPropertyManager(String resourceURI) {
	...
	public static void deleteProperty(String name) {
		if (manager == null) {
			synchronized (managerLock) {
				if (manager == null) {
					manager = new FtpPropertyManager(propsName);
				}
			}
		}
...
//		FtpPropertyManager.SetPropsName("/WEB-INF/ftp.properties");
...
//		FtpPropertyManager.SetPropsName("/WEB-INF/filetransfer.properties");
//		System.out.println(FtpPropertyManager.getProperty("archivesip"));
	}
