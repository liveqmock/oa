 ...
 */
package com.icss.oa.zbs.xtsduty.dao;
...
public class TbXtsWorkinfotypeDAO extends DAO {
    ...
    public TbXtsWorkinfotypeDAO(Connection conn){
        super(conn);
    }

    public TbXtsWorkinfotypeDAO(){
        super();
    }
    ...
    protected void setupFields() throws DAOException {
        ...
        setTableName("TB_XTS_WORKINFOTYPE");
        addKey("WIT_ID");
