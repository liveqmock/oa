 ...
 * @author		wangsu
 */
public class YjsDutyTypeDeleteServlet extends ServletBase {
	...
	*/
	public void performTask(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			response.sendRedirect(request.getContextPath() + "/servlet/YjsDutyTypeManageListServlet?msgid="+msgid);
		}
