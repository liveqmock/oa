 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class SetJournalServlet extends ServletBase {
	protected void performTask(
		HttpServletRequest request,
		HttpServletResponse response)
		throws ServletException, IOException {
		Connection conn = null;
		String journalId = request.getParameter("journal_id");
		Integer jourId = new Integer(journalId);
		String resMonths = request.getParameter("select_journal");
		...
		Integer type = new Integer(TypeConfig.JOURNAL_TYPE);
