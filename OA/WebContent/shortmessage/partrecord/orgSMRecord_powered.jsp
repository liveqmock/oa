...
<%@ page import="com.icss.oa.shortmessage.partrecord.vo.*"%>
...
<%
 ...
 while(iter.hasNext()){
	 ...
	 index --;
%>
tree.add(<%=index%>,<%=commRoot%>,' <%=vo.getCnname()%>','<%=request.getContextPath()%>/servlet/ListOrgSMRecordServlet?orgid=<%=vo.getAccessdepid()%>','','mainFrame')		
<%
}
