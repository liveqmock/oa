              ...
              <td width="100%"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                   ...
                   <% if(!("".equals(sendResult))&&sendResult!=null){ %>                                 
                        <tr height="30">
                          <td width="20%" class="text-01"><div align="right" valign="top"><b>成功发送到：</b></div></td>
                          ...
                          <td width="80%" class="text-01"><div valign="top" align="left"><%=sendResult%></div></td>
                        </tr>
                        <tr>
                          <td height="2" background="<%=request.getContextPath()%>/images/bg-13.gif" class="text-01"></td>
                          <td height="2" background="<%=request.getContextPath()%>/images/bg-13.gif" class="text-01"></td>
                  ...
                  %>
                        <tr height="30">
                          <td width="20%" class="text-01"><div align="right" valign="top"><b>下列用户邮箱已满，只发送提示信息：</b></div></td>
                          <td width="2" valign="top" background="<%=request.getContextPath()%>/images/bg-18.gif"><img src="../userweb/images/bg-18.gif" width="2" height="2"></td>
                          <td width="80%" class="text-01"><div valign="top" align="left"><%=overFlowResult%></div></td>
                        </tr>
                        <tr>
                          <td height="2" background="<%=request.getContextPath()%>/images/bg-13.gif" class="text-01"></td>
                          <td height="2" background="<%=request.getContextPath()%>/images/bg-13.gif" class="text-01"></td>
                  ...
                  %>                        
                        <tr height="30">
                          <td width="20%" class="text-01"><div align="right" valign="top"><b>下列用户邮箱尚未开通：</b></div></td>
                          <td width="2" valign="top" background="<%=request.getContextPath()%>/images/bg-18.gif"><img src="../userweb/images/bg-18.gif" width="2" height="2"></td>
                          <td width="80%" class="text-01"><div valign="top" align="left"><%=noPersonResult%></div></td>
                        </tr>
                        <tr>
                          <td height="2" background="<%=request.getContextPath()%>/images/bg-13.gif" class="text-01"></td>
                          <td height="2" background="<%=request.getContextPath()%>/images/bg-13.gif" class="text-01"></td>
