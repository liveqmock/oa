...
%>
<a href="<%=request.getContextPath()%>/servlet/MessageListServlet?curPageNum=1&type=<%=ptype%>&folder=<%=pfolderSort%>">首 页</a>&nbsp;&#9474;
<%
	}else{
%>
首 页&nbsp;&#9474;
...
if(curPageNum > 1){
%>
<a href="<%=request.getContextPath()%>/servlet/MessageListServlet?curPageNum=<%=priorPageNum%>&type=<%=ptype%>&folder=<%=pfolderSort%>">上一页</a>&nbsp;&#9474;
<%
}else{
%>
上一页&nbsp;&#9474;
...
%>
<a href="<%=request.getContextPath()%>/servlet/MessageListServlet?curPageNum=<%=nextPageNum%>&type=<%=ptype%>&folder=<%=pfolderSort%>">下一页</a>&nbsp;&#9474;
<%
}else{
%>
下一页&nbsp;&#9474;
...
%>
<a href="<%=request.getContextPath()%>/servlet/MessageListServlet?curPageNum=<%=lastPageNum%>&type=<%=ptype%>&folder=<%=pfolderSort%>">尾 页</a>
<%
}else{
%>
尾 页
