...
%>
<a href="<%=request.getContextPath()%>/servlet/SearchMailServlet?curPageNum=1">首 页</a>&nbsp;&#9474;
<%
	}else{
%>
首 页&nbsp;&#9474;
...
if(curPageNum > 1){
%>
<a href="<%=request.getContextPath()%>/servlet/SearchMailServlet?curPageNum=<%=priorPageNum%>">上一页</a>&nbsp;&#9474;
<%
}else{
%>
上一页&nbsp;&#9474;
...
%>
<a href="<%=request.getContextPath()%>/servlet/SearchMailServlet?curPageNum=<%=nextPageNum%>">下一页</a>&nbsp;&#9474;
<%
}else{
%>
下一页&nbsp;&#9474;
...
%>
<a href="<%=request.getContextPath()%>/servlet/SearchMailServlet?curPageNum=<%=lastPageNum%>">尾 页</a>
<%
}else{
%>
尾 页
