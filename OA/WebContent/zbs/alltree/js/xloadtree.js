...
function WebFXLoadTree(sText, sXmlSrc, sAction, sBehavior, sIcon, sOpenIcon, sTarget, sStyle) {//lichg
	// call super
	this.WebFXTree = WebFXTree;
	this.WebFXTree(sText, sAction, sBehavior, sIcon, sOpenIcon, sTarget, sStyle);//lichg
...
function WebFXLoadTreeItem(sText, sXmlSrc, sAction, eParent, sIcon, sOpenIcon, sTarget, sStyle) {//lichg
	// call super
	this.WebFXTreeItem = WebFXTreeItem;
	this.WebFXTreeItem(sText, sAction, eParent, sIcon, sOpenIcon, sTarget, sStyle);//lichg
...
function _xmlTreeToJsTree(oNode) {
	...
	var style = oNode.getAttribute("style");//lichg
	// create jsNode
	var jsNode;
	if (src != null && src != "")
		jsNode = new WebFXLoadTreeItem(text, src, action, parent, icon, openIcon, target, style);//lichg
	else
		jsNode = new WebFXTreeItem(text, action, parent, icon, openIcon, target, style);//lichg

	if (target != "")
		jsNode.target = target || webFXTreeConfig.defaultTarget;
