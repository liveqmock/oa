            ...
            <table width="376"  border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td background="<%=request.getContextPath()%>/images/bg-29.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="25%"><div align="right"><img src="<%=request.getContextPath()%>/images/bg-31.gif" width="80" height="79" vspace="10"></div></td>
                      <td width="75%" class="text-06"><div align="center">
                        <p><%=request.getParameter("errorS")!=null?request.getParameter("errorS"):"请从左面的树中选择"%></p>
                      </div>                        </td>
                    </tr>
                  </table>                  </td>
              </tr>
