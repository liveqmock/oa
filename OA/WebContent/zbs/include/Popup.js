...
function fPopUpCalendarDlg_App()
{
	...
	try{
	    ...
	    newWINwidth = 202;
            ...
            winPopupWindow.win = window.open("/CalendarDlg.htm","CalendarDialog","dependent=yes,width="+newWINwidth + ",height=182px" )
            winPopupWindow.win.focus()
            return winPopupWindow;
	}else{
	    retval = window.showModalDialog("/CalendarDlg.htm", "", "dialogWidth:197px; dialogHeight:210px; status:no; directories:yes;scrollbars:no;Resizable=no; "  );
        }
