...
N = (document.all) ? 0 : 1;
	...
	var endtarget;
		...
		endtarget = "/source/style/js/masterref/popup_posincharge.htm";
...
function fPopUpCalendarTimeDlg(ctrlobj)
{
	...
	if(N){
	    window.top.captureEvents (Event.CLICK|Event.FOCUS);
            ...
            winPopupWindow.args = ctrlobj;
	    newWINwidth = 202;
            winPopupWindow.win = window.open("/source/style/js/calendar/masterref/CalendarDlg.htm","CalendarDialog","dependent=yes,left="+showx + ",top=" + showy + ",width="+newWINwidth + ",height=182px" )
            winPopupWindow.win.focus()
            return winPopupWindow;
	}else{
	    retval = window.showModalDialog("/source/style/js/calendar/masterref/CalendarDlg.htm", "", "dialogWidth:197px; dialogHeight:210px; dialogLeft:"+showx+"px; dialogTop:"+showy+"px; status:no; directories:yes;scrollbars:no;Resizable=no; "  );
        }
...
function fPopUpCalendarTimeDlg_New(ctrlobj)
{
	...
	if(N){
	    window.top.captureEvents (Event.CLICK|Event.FOCUS);
            ...
            winPopupWindow.args = ctrlobj;
	    newWINwidth = 202;
            winPopupWindow.win = window.open("/source/style/js/calendar/masterref/CalendarDlgTime.htm","CalendarDialog","dependent=yes,left="+showx + ",top=" + showy + ",width="+newWINwidth + ",height=182px" )
            winPopupWindow.win.focus()
            return winPopupWindow;
	}else{
	    retval = window.showModalDialog("/source/style/js/calendar/masterref/CalendarDlgTime.htm", "", "dialogWidth:197px; dialogHeight:250px; dialogLeft:"+showx+"px; dialogTop:"+showy+"px; status:no; directories:yes;scrollbars:no;Resizable=no; "  );
        }
...
function fPopUpCalendarTimeDlg_NewReturn(ctrlobj)
{
	...
	if(N){
	    ...
	    retval = window.showModalDialog("/source/style/js/calendar/masterref/CalendarDlgTime.htm", "", "dialogWidth:197px; dialogHeight:230px; dialogLeft:"+showx+"px; dialogTop:"+showy+"px; status:no; directories:yes;scrollbars:no;Resizable=no; "  );
        }
...
function fPopUpCalendarTimeDlg_App()
{
	...
	try{
	    ...
	    newWINwidth = 202;
            ...
            winPopupWindow.win = window.open("/source/style/js/calendar/masterref/CalendarDlgTime.htm","CalendarDialog","dependent=yes,width="+newWINwidth + ",height=210px" )
            winPopupWindow.win.focus()
            return winPopupWindow;
	}else{
	    retval = window.showModalDialog("/source/style/js/calendar/masterref/CalendarDlgTime.htm", "", "dialogWidth:197px; dialogHeight:210px; status:no; directories:yes;scrollbars:no;Resizable=no; "  );
        }
