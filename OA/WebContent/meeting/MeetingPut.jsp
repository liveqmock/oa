...
function IsFormItemEmpty(){
    ...
    if(getLength(document.form_update.MeetingName.value)>10){
...
<%
		...
		String modulename = StatPropertyManager.getString("stat_module10");   
...
<form name="form_list" action="" method="post">
  <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td  background="<%=request.getContextPath()%>/images/bg-12.gif" class="title-05">会议室申请列表</td>
          ...
          <td background="<%=request.getContextPath()%>/images/bg-09.jpg">
		  	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
            	<tr>
                      ...
                      <td width="40%" height="22" bgcolor="#FFFBEF"><div align="center" class="title-04">名称</div></td>
                      <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                      <td width="10%" bgcolor="#FFFBEF"><div align="center" class="title-04">会议性质</div></td>
					            <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                      <td width="12%" height="22" bgcolor="#FFFBEF"><div align="center" class="title-04">会议室</div></td>
                      <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                      <td width="8%" height="22" bgcolor="#FFFBEF"><div align="center" class="title-04">申请状态</div></td>
                      <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                      <td width="8%" height="22" bgcolor="#FFFBEF"><div align="center" class="title-04">申请时间</div></td>
                      <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                      <td width="5%" height="22" bgcolor="#FFFBEF"><div align="center" class="title-04">管理员备注</div></td>
                       <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                      <td width="8%" height="22" bgcolor="#FFFBEF"><div align="center" class="title-04">与会人员</div></td>
                      <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                      <td width="5%" height="22" bgcolor="#FFFBEF"><div align="center" class="title-04">操作</div></td>
...
%>    	
						...
						<td height="22" class="text-01" align="center"><input type="checkbox" name="PutId" value="<%= vo.getPutId()%>"></td>
                      	<td class="text-01" align="left">
											<% if(("申请中").equals(vo.getMeetingSatus())){ %>
		                  <img alt="申请中的会议" src="<%=request.getContextPath()%>/images/meeting/kkk.gif" width="15" height="15" border=0"> 
		                  <%}%>
                          
                      <% if(("已确认").equals(vo.getMeetingSatus())){ %>
		                  <img alt="已确认的会议" src="<%=request.getContextPath()%>/images/meeting/ok1.gif" width="15" height="15" border=0"> 
		                  <%}%>
                           
                      <% if(("未确认").equals(vo.getMeetingSatus())){ %>
		                  <img alt="未确认的会议" src="<%=request.getContextPath()%>/images/meeting/not.gif" width="15" height="15" "border=0"> 
		                  <%}%>
 						  
                      <% if(("发布中").equals(vo.getMeetingSatus())){ %>
		                  <img alt="已经发布的会议" src="<%=request.getContextPath()%>/images/meeting/pics-09.gif" width="15" height="15" border=0"> 
		                  <%}%>
                          
                      <% if(("会议开始").equals(vo.getMeetingSatus())){ %>
		                  <img alt="已经开始的会议" src="<%=request.getContextPath()%>/images/meeting/start.gif" width="15" height="15" border=0"> 
		                  <%}%>
			
			                <% if(("会议结束").equals(vo.getMeetingSatus())){ %>
		                  <img alt="已经结束的会议" src="<%=request.getContextPath()%>/images/meeting/over.gif" border=0"> 
		                  <%}%>
                        <a href="#" onclick="javascript:window.open('<%=request.getContextPath()%>/servlet/ShowMeetingServlet?putId=<%= vo.getPutId()%>&type=kk','','width=800,height=400,toolbar=0,directories=0,status=0,menu=0,scrollbars=yes,resizable=yes,copyhistory=no,left=50,top=20');">
          						<%= vo.getMeetingName()%>
                        </a></td>
                      	...
                      	<a href="#" onclick="javascript:window.open('<%=request.getContextPath()%>/servlet/ShowMeetingPServlet?putId=<%= vo.getPutId()%>','','width=700,height=400,toolbar=0,directories=0,status=0,menu=0,scrollbars=yes,resizable=yes,copyhistory=no,left=50,top=20');">查看</a></td>
                      	<td class="text-01" align="center"><a href = "<%=request.getContextPath()%>/servlet/ListMeetingPersonServlet?putId=<%= vo.getPutId()%>">查看</a></td>
                      	<td class="text-01" align="center"><a href = "<%=request.getContextPath()%>/servlet/MeetingPutServlet?putId=<%= vo.getPutId()%>">修改</a></td>
						<tr>
                      <td height="2" background="<%=request.getContextPath()%>/images/bg-13.gif"></td>
                      <td background="<%=request.getContextPath()%>/images/bg-13.gif"></td>
                      <td background="<%=request.getContextPath()%>/images/bg-13.gif"></td>
...
%>
  ...
  <div align="center"><br>
    <img src="<%=request.getContextPath()%>/images/meeting/button-newattend.gif" border=0 style="cursor:hand" onClick="_Add()">&nbsp;
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" id="search"  >
  <tr>
    ...
    <td width="" valign="top">
      <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
                      		<input name="flag" type="hidden" value="Not" >
        <tr>
          <td width="2%" background="<%=request.getContextPath()%>/images/bg-12.gif"><img src="<%=request.getContextPath()%>/images/bg-10.gif" width="14" height="22"></td>
          <td background="<%=request.getContextPath()%>/images/bg-12.gif" class="title-05">会议室申请查询</td>
              ...
              <tr>
                <td background="<%=request.getContextPath()%>/images/bg-09.jpg">
				  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="22" class="text-01"><div align="right">会议状态：</div></td>
                      <td bgcolor="F2F9FF" class="text-01">
