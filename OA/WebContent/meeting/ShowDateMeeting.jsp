...
%> 
                        <td width="16%" height="30" class="title-04" align="center"><%= vo.getMeetName()%></td>
                         <td width="12%"  >
							...
							while(it0.hasNext()){
						        ...
						        <%= vo0.getMeetingName()%>&nbsp;<%= person.getFullName()%>&nbsp;<%= vo0.getMeetingPutdep() %>&nbsp;开始时间<%=com.icss.oa.util.CommUtil.getTimeByLong(vo0.getStarttimeday())%>&nbsp;<%= vo0.getStartimehour() %>--<%=com.icss.oa.util.CommUtil.getTimeByLong(vo0.getEndtimeday())%>&nbsp;开始时间<%= vo0.getEndtimehour() %><p>
						           <%}%>
                        </td>
						<td width="12%" >
						<% String kk1 = vo.getMeetName()+"2";
							...
							while(it1.hasNext()){
						        ...
						        <%= vo1.getMeetingName()%>&nbsp;<%= person.getFullName()%>&nbsp;<%= vo1.getMeetingPutdep()%>&nbsp;<%= vo1.getStartimehour() %>--<%= vo1.getEndtimehour() %><p>
						           <%}%></td>
						<td width="12%">
						<% String kk2 = vo.getMeetName()+"3";
							...
							while(it2.hasNext()){
						        ...
						        <%= vo2.getMeetingName()%>&nbsp;  <%= person.getFullName()%>&nbsp;<%= vo2.getMeetingPutdep()%>&nbsp;<%= vo2.getStartimehour() %>--<%= vo2.getEndtimehour() %><p>
						         <%  }%></td>
						<td width="12%" >
						<% String kk3 = vo.getMeetName()+"4";
							...
							while(it3.hasNext()){
						        ...
						        <%= vo3.getMeetingName()%>&nbsp;   <%= person.getFullName()%>&nbsp;<%= vo3.getMeetingPutdep()%>&nbsp;<%= vo3.getStartimehour() %>--<%= vo3.getEndtimehour() %><p>
						          <% }%></td>
						<td width="12%">
						<% String kk4 = vo.getMeetName()+"5";
							...
							while(it4.hasNext()){
						        ...
						        <%= vo4.getMeetingName()%>&nbsp; <%= person.getFullName()%>&nbsp;<%=  vo4.getMeetingPutdep()%>&nbsp;<%= vo4.getStartimehour() %>--<%= vo4.getEndtimehour() %><p>
						          <%}%></td>
						<td width="12%" >
						<% String kk5 = vo.getMeetName()+"6";
							...
							while(it5.hasNext()){
						        ...
						        <%= vo5.getMeetingName()%>&nbsp;   <%= person.getFullName()%>&nbsp;<%= vo5.getMeetingPutdep()%>&nbsp;<%= vo5.getStartimehour() %>--<%= vo5.getEndtimehour() %><p>
						           <%}%></td>
						<td width="12%" >
						<% String kk6 = vo.getMeetName()+"7";
							...
							while(it6.hasNext()){
						        ...
						        <%= vo6.getMeetingName()%>&nbsp;   <%= person.getFullName()%>&nbsp;<%= vo6.getMeetingPutdep()%>&nbsp;<%= vo6.getStartimehour() %>--<%= vo6.getEndtimehour() %><p>
						          <% }%></td>                                            
				    </tr>
                    <tr>
                      <td height="2"  background="<%=request.getContextPath()%>/images/bg-13.gif"></td>
