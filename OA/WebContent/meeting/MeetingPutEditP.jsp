...
function _Update(){
     	...
     	if(!IsFormItemEmpty()){
			document.form_update.action="<%=request.getContextPath()%>/servlet/EditMeetingPutSevletP";
              ...
              <tr>
                <td background="<%=request.getContextPath()%>/images/bg-09.jpg"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                   <tr>
                      ...
                      <td width="319" bgcolor="F2F9FF" class="text-01"><%= vo.getMeetingName()%>
                	  <input name="MeetingName" type="hidden" value="<%= vo.getMeetingName()%>" size="29" readonly></td>
                      ...
                      <td width="2" rowspan="2" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
					  <td  bgcolor="F2F9FF"  class="text-01"><%= vo.getMeetingType()%>        
                      <input name="MeetingType" type="hidden" value="<%= vo.getMeetingType()%>">
                      </td>  
                    </tr>
                    <tr>
...
<select name="MeetingEndTimeHour">
  ...
  <option value="55" <%= vo.getEndtimehour().substring(nPosition1+1).equals("55")?"selected":""%>>55</option>
                    ...
                    <tr>
                	  ...
                	  <img  src="<%=request.getContextPath()%>/images/meeting/button-meetingroom.gif" onClick="_MeetingUse()" style="cursor:hand"></td></td>
                      <td width="2" rowspan="2" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                    ...
                    <tr>
                      ...
                      <td width="2" rowspan="2" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"></td>
                      <td width="319" bgcolor="F2F9FF" class="text-01"><textarea cols="40" readonly rows="5"><%= vo.getMeetingNeedingutil()!=null?vo.getMeetingNeedingutil():""%></textarea></td>
                      <td width="2" rowspan="2" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"></td>
                      <td width="100" height="22" class="text-01" align="right">会议概要：</td>
                      <td width="2" rowspan="2" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"></td>
                      <td  bgcolor="F2F9FF" class="text-01"><textarea cols="40" readonly rows="5"><%= vo.getPutMeno()!=null?vo.getPutMeno():""%></textarea>
                    ...
                    <tr>
                      <td width="100" height="22" class="text-01" align="right">管理员备注：</td>
                      <td width="2" rowspan="2" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"></td>
                      <td width="319" bgcolor="F2F9FF" class="text-01">
                      <textarea name="MeetingConcept" cols="40" rows="5"><%=vo.getMeetingConcept()!=null?vo.getMeetingConcept():""%></textarea>
                       <td width="" bgcolor="F2F9FF" class="text-01">
                        <td width="" bgcolor="F2F9FF" class="text-01">
                        <td width="" bgcolor="F2F9FF" class="text-01">
                        <td width="" bgcolor="F2F9FF" class="text-01">
                    ...
                    <tr>
                       <td width="100" height="22" class="text-01" align="right">是否确认：</td>
                      <td width="2" rowspan="2" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"></td>
                      <td  bgcolor="F2F9FF" class="text-01">
					  <select name="PiZhun">
					  <option value="未确认" <%= "未确认".equals(vo.getMeetingSatus())?"selected":""%>>未确认</option>
  					  <option value="已确认" <%= "已确认".equals(vo.getMeetingSatus())?"selected":""%>>已确认</option>
