...
function _moveOk(){
  	if(document.Form_MovetoSort.targetFolderId.value==""||
  	   document.Form_MovetoSort.folderId.value==""){
  	 	...
  	 	document.Form_MovetoSort.action="<%=request.getContextPath()%>/servlet/UploadAccessServlet";
...
<br>
<div class="title-04">&nbsp;请选择保存附件的位置：</div><br>
<table width="178" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF">
<SCRIPT language="JavaScript" >
var a=new TreeView('a','_parent','javascript:getId("","","")')
a.add(-1,0,'网络文件夹','#')					  
