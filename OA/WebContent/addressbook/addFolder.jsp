      ...
      <td valign="top" background="<%=request.getContextPath()%>/images/bbs/newbbs/bg-08.gif"> 
        <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
          <tr> 
            ...
            <td width="97%" background="<%=request.getContextPath()%>/images/bbs/newbbs/bg-12.gif" class="title-05">分组添加</td>
                      ...
                      <tr> 
                        ...
                        <td width="80%" bgcolor="F2F9FF" class="text-01"><table  border="0" cellspacing="0" cellpadding="0">
                            <tr> 
							  ...
							  <td><font color="#003300">**您输入的分组重名**</font></td>
							  <% } %>
							   <% if(new String("") .equals((request.getParameter("folderName")))){ %>
							  <td><font color="#003300">**请您输入分组名称**</font></td>
							  <% } %>
...
<script language="JavaScript">
 function _addFolder(url,parentId){
	...
	document.form1.action=url+"/servlet/AddAddrbookFolderServlet?parentId="+parentId;
