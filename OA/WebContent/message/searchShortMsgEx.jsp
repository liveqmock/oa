...
<%@ page import="com.icss.oa.message.vo.MsgSendSearchVO" %>
...
function _viewBack(msgMid){
	window.top.mainFrame.location="<%=request.getContextPath()%>/servlet/ListBackMsgServlet?msgMid="+msgMid+"&searchOld=<%=request.getParameter("searchOld")%>";
}
    ...
    <br>
        ...
        <table align="center" width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/images/bg-12.gif" class="title-05">短信搜索结果列表</td>
            ...
            <td width="100%"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/images/bg-09.jpg"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                      	<td height="22" nowrap align="center" bgcolor="#FFFBEF" class="title-04">&nbsp;发布人&nbsp;</td>
                        ...
                        <td nowrap align="center" bgcolor="#FFFBEF" class="title-04">&nbsp;发布时间&nbsp;</td>
                        <td width="2" rowspan="100" align="center" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                        <td nowrap align="center" bgcolor="#FFFBEF" class="title-04">&nbsp;内容概要&nbsp;</td>
                        <td width="2" rowspan="100" align="center" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                        <td nowrap align="center" bgcolor="#FFFBEF" class="title-04">&nbsp;发送时间&nbsp;</td>
                        ...
                        <td nowrap align="center" bgcolor="#FFFBEF" class="title-04">&nbsp;查看回复&nbsp;</td>
                      </tr>
                      <tr>
...
<%
	...
	while(it.hasNext()){
		++i;
		MsgSendSearchVO vo = (MsgSendSearchVO)it.next();
		if(i%2==1){
%>
...
%>
                        ...
                        <td nowrap align="center" class="text-01">&nbsp<%=vo.getOcnname()%>&nbsp;</td>
                        ...
                        <td nowrap align="center" class="text-01">&nbsp;<a href="#" onclick="javascript:_viewBack('<%=vo.getMsMid()%>')">查看</a>&nbsp;</td>
                      </tr>
                      <tr>
                        <td background="<%=request.getContextPath()%>/images/bg-13.gif"></td>
                        <td background="<%=request.getContextPath()%>/images/bg-13.gif"></td>
