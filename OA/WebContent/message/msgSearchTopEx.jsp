...
function _search(){
	...
	if(getLength(Form_SearchSort.sendPerson.value)>40){
    	alert("发送人名称过长（最大长度为20个汉字或40个英文字母）！");
    	return;
    }
	if(getLength(Form_SearchSort.sendOrg.value)>40){
    	alert("发送组织名称过长（最大长度为20个汉字或40个英文字母）！");
    	return;
    }
...
function _reset(){
	...
	Form_SearchSort.sendPerson.value="";
	Form_SearchSort.sendOrg.value="";
...
<form name="Form_SearchSort" action="<%=request.getContextPath()%>/servlet/SearchShortMsgExServlet"  target="searchResultFrame">
<br>
            ...
            <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <table width="100%"  border="0" cellspacing="0" cellpadding="0">             
                      <tr>
                        <td nowrap width="9%" align="right" class="text-01">内容：</td>
                        ...
                        <td nowrap width="12%" align="left" bgcolor="F2F9FF" class="text-01">
            				<input name="content" type="text" size="10">&nbsp;</td>
                        <td width="2" rowspan="100" align="center" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                        <td nowrap width="9%" align="right" class="text-01">发送人：</td>
                        <td width="2" rowspan="100" align="center" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                        <td nowrap width="12%" align="left" bgcolor="F2F9FF" class="text-01">
            				<input name="sendPerson" type="text" size="10">&nbsp;</td>
                        <td width="2" rowspan="100" align="center" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
           				<td nowrap width="9%" align="right" class="text-01">发送组织：</td>
                        <td width="2" rowspan="100" align="center" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
            			<td nowrap width="12%" align="left" bgcolor="F2F9FF" class="text-01">
            				<input name="sendOrg" type="text" size="10">&nbsp;</td>
                        <td width="2" rowspan="100" align="center" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
           				<td nowrap width="9%" align="right" class="text-01">时&nbsp;&nbsp;间：</td>	
           				<td width="2" rowspan="100" align="center" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
           				<td nowrap width="28%" align="left" bgcolor="F2F9FF" class="text-01">
