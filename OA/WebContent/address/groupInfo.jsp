      ...
      <td valign="top"><div align="center"><br>
          ...
          <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td background="<%=request.getContextPath()%>/images/bg-12.gif"  class="title-05"><%=groupname%>  分组人员列表</td>
...
System.out.println("~~~~"+groupinfoCollection.toString());
while(groupinfoIterator.hasNext()){
    ...
    try{
		...
		System.out.println("~~~~"+groupInfoVO.getUserid());
