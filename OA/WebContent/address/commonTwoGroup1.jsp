...
<jsp:useBean id="handler1" class="com.icss.oa.address.handler.Group"/>
...
function _kk(){
	window.open("<%=request.getContextPath()%>/servlet/getTransfPower?doFuntion=_addTranfs","","width=800,height=600,scrollbars=yes,resizable=yes,left=100,top=110");
}
</script>    
</head>
...
%>
          <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td background="<%=request.getContextPath()%>/images/bg-12.gif"  class="title-05">二级公共分组列表
     </td>
                  ...
                  <tr>
                    ...
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr  bgcolor="#FFFBEF">
                        ...
                        <td width="4%" ><div align="center" class="title-04">编号</div></td>
                        <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                        <td width="25%" ><div align="center" class="title-04">名称</div></td>
                        <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                        <td width="25%" ><div align="center" class="title-04">描述</div></td>
                        <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                        <td width="15%" ><div align="center" class="title-04">该分组的建立者</div></td>
                        <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                        <td width="15%" ><div align="center" class="title-04">现在的维护人员</div></td>
                        <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                        <td width="15%" height="22"><div align="center" class="title-04">分组人员</div></td>
...
%>
<tr bgColor='#D8EAF8'>
   <td height="52" class="text-01" colspan=19><div align="center">
                <br><br>还没有分组信息！
                        </div></td>
                      ...
                      <tr>
                        <td colspan=19 height="2" background="<%=request.getContextPath()%>/images/bg-13.gif" class="text-01"></td>
...
%>
                      <tr bgcolor=<%=color%> onMouseOut="this.bgColor='<%=color%>';" onMouseOver="this.bgColor='#8CC0E8';">
                        ...
                        <td  class="text-01"><div align="center"><%=handler1.getCnnamebyUUID(addressGroupVO.getOwner())%></div></td>
                        <td  class="text-01"><div align="center">
                            <a href="ListGroupTransfServlet?groupid=<%=addressGroupVO.getId()%>&Groupname=<%=addressGroupVO.getGroupname()%>">移交</a></div></td>
                        <td class="text-01"><div align="center">
							<a href="ListGroupInfoServlet?groupid=<%=addressGroupVO.getId()%>&type=<%=AddressConfig.GROUPTYPE_COMMOM%>">查看</a>
							<%if(!handler1.personInGroupbyNameIsNull(addressGroupVO.getId(),AddressConfig.GROUPTYPE_COMMOM)){%>
                            <font color="red">[无人]</font></div><%}%>
						</td>
                      </tr>
...
<br>
    ...
    <img src="<%=request.getContextPath()%>/images/botton-return.gif" onclick="_back1()" style="cursor:hand"> <br>
