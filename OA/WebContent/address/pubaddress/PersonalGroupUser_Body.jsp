...
function _addPerson(usernamestring){
	window.top.bodyfrm.location = "<%=request.getContextPath()%>/servlet/AddGroupInfoServlet?groupid=<%=request.getParameter("groupid")%>&type=<%=request.getParameter("type")%>";
	return true;
}
...
%>
          ...
          <td bgcolor="#FFFFFF" class="message_title_bold" width="15%"><div align="center"><%= person.getJob()== null?"":person.getJob() %></div>
