...
function _back(){
   window.location.href = "<%=request.getContextPath()%>/servlet/SelectCommonTwoLevelGroupServlet?groupid=<%= request.getAttribute("groupid")%>&doFunction=<%= request.getParameter("doFunction")%>&sessionname=<%= request.getParameter("sessionname")%>";
}
