...
%>
                      <tr bgcolor=<%=color%> onMouseOut="this.bgColor='<%=color%>';" onMouseOver="this.bgColor='#8CC0E8';">
                        ...
                        <a href="<%=request.getContextPath()%>/servlet/ListCommonTwoGroupServlet?ParentID=<%=addressGroupVO.getId()%>&shouquan=<%=addressGroupVO.getNeedaccredit()%>"><%=addressGroupVO.getGroupname()%></a></div></td>
	                    ...
	                    %>  
	                        <div align="center">
								<a href="ListGrouprightServlet?groupid=<%=addressGroupVO.getId()%>">授权</a></div>
						<%
						}else{
						%>		
	                        <div align="center">
