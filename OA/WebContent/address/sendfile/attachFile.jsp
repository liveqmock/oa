...
function _delAttach(index){
	document.attachForm.action="<%=request.getContextPath()%>/servlet/SendFileDelAttachServlet?attach="+index;
...
<div align="center" >
          <table width="75%"  border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td background="<%=request.getContextPath()%>/images/bg-12.gif" class="title-05">附加文件new</td>
