...
<!--
	...
	function CheckAll()
	 ...
	 function All_Person(){
		var orgname ='<%=(String)request.getAttribute("orgname")%>';
		var orguuid ='<%=(String)request.getAttribute("orguuid")%>';
		//alert(orgname+","+orguuid);
		document.personform.method = "post";
		document.personform.action = "<%=request.getContextPath()%>/servlet/SendFileSelectPersonServlet?orgname="+orgname+"&orgid="+orguuid;
...
<INPUT type="checkbox" name="allperson" value="All Person" onclick="All_Person();">该组织下人员全部展现
