              ...
              <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td background="<%=request.getContextPath()%>/images/bg-09.jpg"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td nowrap width="15%" height="22" class="text-01">
                          <!--<div align="right">
                          <a href="#" onclick="javascript:_selectPerson()" title="选择收信人">收件人</a>(<font color='red'>*</font>)：
                          </div>-->
                          <div align="right"><img src="<%=request.getContextPath()%>/images/filetransfer/button-rece.gif" style="cursor:hand" align="absmiddle"  onClick="javascript:_selectPerson()" alt="选择收信人"></div>
                          </td>
                          ...
                          <td width="85%" bgcolor="F2F9FF" class="text-01">
                              ...
                              <img src="<%=request.getContextPath()%>/images/filetransfer/button-rece.gif" style="cursor:hand" align="absmiddle"  onClick="javascript:_selectPerson()" alt="选择收信人">
                          	</td></tr></table>
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td nowrap bgcolor="F2F9FF" >
                              <input type="text" name="topic"  size="55" class=txt2 maxlength="50" onkeydown="mm()">&nbsp;（<font color='red'>少于25个汉字</font>）
                        ...
                        <tr>
                          <td nowrap height="22" class="text-01"><!--<div align="right"><a href="#" title="选择抄送人" onclick="javascript:_selectcc()">抄送：</a></div>-->
                          <div align="right"><img src="<%=request.getContextPath()%>/images/filetransfer/button-cc.gif" style="cursor:hand" align="middle"  onClick="javascript:_selectcc()" alt="选择抄送人"></div></td>
                          <td bgcolor="F2F9FF" class="text-01">
							  ...
							  <img src="<%=request.getContextPath()%>/images/filetransfer/button-cc.gif" style="cursor:hand" align="middle"  onClick="javascript:_selectcc()" alt="选择抄送人">
                          </td></tr></table>
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td nowrap height="22" class="text-01"><!--<div align="right"><a href="#" title="选择密送人" onclick="javascript:_selectbcc()">密送：</a></div>-->
                          <div align="right"><img src="<%=request.getContextPath()%>/images/filetransfer/button-bcc.gif" style="cursor:hand" align="middle"  onClick="javascript:_selectbcc()" alt="选择密送人"></div></td>
                          <td bgcolor="F2F9FF" class="text-01">
							  ...
							  <img src="<%=request.getContextPath()%>/images/filetransfer/button-bcc.gif" style="cursor:hand" align="middle"  onClick="javascript:_selectbcc()" alt="选择密送人">
                          </td></tr></table>
                          </td>
                        </tr>
                        <tr>
