...
%>
					<tr bgcolor=<%=color%> onMouseOut="this.bgColor='<%=color%>';" onMouseOver="this.bgColor='#8CC0E8';">
                        ...
                        <td height="22"   class="text-01"><div align="center"><a href="SendFileSelectCommonTwoLevelGroupServlet?groupid=<%=addresscommongroupvo.getGroupid()%>&shouquan=<%=addresscommongroupvo.getNeedaccredit()%>&flag=<%=flag%>"><%=StringUtil.escapeNull(addresscommongroupvo.getGroupname())%></a></div></td>
					</tr>
                      <tr>
