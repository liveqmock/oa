...
%>
       <a href="<%=request.getContextPath()%>/servlet/DownloadAttachServlet?url=<%=attachFileBean.getDownloadUrl()%>&filename=<%=attachFileBean.getFileOriginName()%>" target="<%= attachFileBean.getFileOriginName()%>" onblur="return func_1(this, event);"><font color="red"><b>点击下载&nbsp;<%=attachFileBean.getFileOriginName()%>(<%=AttachHelper.getFileSize(attachFileBean.getFilesize())%>)</font></a>&nbsp;&nbsp;
