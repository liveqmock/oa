              ...
              <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td background="<%=request.getContextPath()%>/images/bg-09.jpg"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td nowrap width="15%" height="22" class="text-01"><div align="right"><a href="#" onclick="javascript:_selectPerson()" title="选择收信人">收件人</a>(<font color='red'>*</font>)：</div></td>
                        ...
                        <tr>
                          <td nowrap height="22" class="text-01"><div align="right"><a href="#" title="选择抄送人" onclick="javascript:_selectcc()">抄送：</a></div></td>
                        ...
                        <tr>
                          <td nowrap height="22" class="text-01"><div align="right"><a href="#" title="选择密送人" onclick="javascript:_selectbcc()">密送：</a></div></td>
                          <td bgcolor="F2F9FF" class="text-01">
