...
Collection TranList = (Collection)request.getAttribute("TranList");

Iterator TranListIterator = TranList.iterator();
...
function _selectPerson(){
	window.open('<%=request.getContextPath()%>/servlet/getTransfPower?Groupname=<%=request.getParameter("Groupname")%>&groupid=<%=request.getParameter("groupid")%>','addressbook','width=300,height=550,scrollbars=yes,resizable=yes');
}

function _addPerson(groupid){
	window.top.mainFrame.location = "<%=request.getContextPath()%>/servlet/ListGroupTransfServlet?groupid="+groupid;
...
function _deletePeople(){
	if(check()){
		document.groupForm.action="<%=request.getContextPath()%>/servlet/DelTransfServlet";
...
<input type="hidden" name="groupid" value="<%=(String)request.getParameter("groupid")%>">
      ...
      <td valign="top"><div align="center"><br>
          ...
          <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td background="<%=request.getContextPath()%>/images/bg-12.gif"  class="title-05">移交人员列表</td>
                  ...
                  <tr>
                    <td background="<%=request.getContextPath()%>/images/bg-09.jpg"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                        <tr  bgcolor="#FFFBEF">
                          ...
                          <td width="2"  rowspan="100"  valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                          <td width="14%" ><div align="center" class="title-04">电话</div></td>
                          <td width="2"  rowspan="100"  valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
...
while(TranListIterator.hasNext()){
	AddressTransferVO groupInfoVO = (AddressTransferVO)TranListIterator.next();
    ...
    try{
		person = entityManager.findPersonByUuid(groupInfoVO.getPersonuuid());
		k11 = person.getSex();
	}
...
%>
                       ...
                       <input type="checkbox" name="personid1" value="<%=groupInfoVO.getId()%>">  
<%
            String sex ="未知";
...
%>
                          ...
                          <td  class="text-01"><div align="center"><%= handler.getPersonJUPositionInJsp(groupInfoVO.getPersonuuid())%></div></td>
