...
function showDesc(url){
	...
	var groupObj = document.getElementsByName("personGroup");
	if (groupObj.length != 1){
		alert("页面中不允许有name为personGroup的节点!");
	}
	groupObj[0].src = url;
	var ix = 200;
	var iy = 200;
	...
	try{
		...
		var x = event.x;
		var y = event.offsetY;
		var tcx = event.offsetX;

		x = x-(ix/2);
		y = y + 60;
		var hMax = document.body.offsetHeight;
...
function loadWin(url){
	var str = "<div id=\"descDiv\" style=\"height:250px;width:220px;position: absolute; border: 1px solid #000000; background-color:#356b97; display:none\" >\n	<table border=\"0\" height=\"100%\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" bgcolor=\"#356b97\" >\n<tr><td style=\"height:0px\" align=\"right\"><img src = \"/oabase/images/closeX.gif\" onclick=\"_cancel();\" title=\"关闭\"></td></tr>		<tr>\n			<td style=\"height:100%\" valign=\"top\">\n";
	str +="<IFRAME name=\"personGroup\" src=\"" + url + "\" style=\"height:250px;width:220px;border-color:#356b97;border-width:2px;border-style:solid\"></IFRAME>";
	str +="</td>\n		</tr>\n	</table>\n</div>";
...
function _cancel(){
	...
	tempObj = document.all("descDiv");
	if (tempObj != null){
		tempObj.outerHTML = "";
	}
}
function _setScr(type){
	if (type){
