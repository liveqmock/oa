...
<%
try{
String url = "&startTime="+startTime+"&endTime="+endTime+"&subject="+subject+"&folder="+folderSort+"&isRead="+isRead;
...
%>
<a href="<%=request.getContextPath()%>/servlet/SearchMailServlet?curPageNum=1<%=url%>" style="text-decoration:none" >首 页</a>&nbsp;&#9474;
<%
	}else{
%>
首 页&nbsp;&#9474;
...
if(curPageNum > 1){
%>
<a href="<%=request.getContextPath()%>/servlet/SearchMailServlet?curPageNum=<%=priorPageNum%><%=url%>" style="text-decoration:none" >上一页</a>&nbsp;&#9474;
<%
}else{
%>
上一页&nbsp;&#9474;
...
%>
<a href="<%=request.getContextPath()%>/servlet/SearchMailServlet?curPageNum=<%=nextPageNum%><%=url%>" style="text-decoration:none" >下一页</a>&nbsp;&#9474;
<%
}else{
%>
下一页&nbsp;&#9474;
...
%>
<a href="<%=request.getContextPath()%>/servlet/SearchMailServlet?curPageNum=<%=lastPageNum%><%=url%>" style="text-decoration:none" >尾 页</a>
<%
}else{
%>
尾 页
