...
%>
<a href="<%=request.getContextPath()%>/servlet/SetSizeServlet?curPageNum=1&orgid=<%=request.getAttribute("orgid")%>">首 页</a>&nbsp;&#9474;
<%
	}else{
%>
首 页&nbsp;&#9474;
...
if(curPageNum > 1){
%>
<a href="<%=request.getContextPath()%>/servlet/SetSizeServlet?curPageNum=<%=priorPageNum%>&orgid=<%=request.getAttribute("orgid")%>">上一页</a>&nbsp;&#9474;
<%
}else{
%>
上一页&nbsp;&#9474;
...
%>
<a href="<%=request.getContextPath()%>/servlet/SetSizeServlet?curPageNum=<%=nextPageNum%>&orgid=<%=request.getAttribute("orgid")%>">下一页</a>&nbsp;&#9474;
<%
}else{
%>
下一页&nbsp;&#9474;
...
%>
<a href="<%=request.getContextPath()%>/servlet/SetSizeServlet?curPageNum=<%=lastPageNum%>">尾 页</a>
<%
}else{
%>
尾 页
