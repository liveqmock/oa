...
String sysreason = request.getParameter("sysreason")==null?"":request.getParameter("sysreason");
String syspheno = request.getParameter("syspheno")==null?"":request.getParameter("syspheno");
String sysdesc = request.getParameter("sysdesc")==null?"":request.getParameter("sysdesc");
System.out.println("attachfile++++++++++++++sysid="+sysid);
...
function _submit(){
	...
	document.doattach.action="<%=request.getContextPath()%>/servlet/UploadLogMsgAttachServlet";
...
<BODY leftmargin="10"
	background="<%=request.getContextPath()%>/images/bg-08.gif">
...
<table width="75%" border="0" align="center" cellpadding="0"
	...
	<tr>
		<td width="2%"
			background="<%=request.getContextPath()%>/images/bg-12.gif"><img
			src="<%=request.getContextPath()%>/images/bg-10.gif" width="14"
			height="22"></td>
		<td background="<%=request.getContextPath()%>/images/bg-12.gif"
			class="title-05">附加文件</td>
		<td width="1%">
		<div align="right"><img
			src="<%=request.getContextPath()%>/images/bg-11.gif" width="20"
			height="22"></div>
		</td>
	</tr>
</table>
<table width="75%" border="0" align="center" cellpadding="0"
	...
	<tr>
		<td width="1"
			background="<%=request.getContextPath()%>/images/bg-21.gif"><img
			src="<%=request.getContextPath()%>/images/bg-21.gif" width="1"
			height="4"></td>
			...
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						...
						<img
							src="<%=request.getContextPath()%>/images/filetransfer/button-confirm.gif"
							onclick="javascript:_confirm()" style="cursor:hand">&nbsp;&nbsp;
							<!-- <img
							src="<%=request.getContextPath()%>/images/filetransfer/button-addanother.gif"
							onclick="javascript:_addNext()" style="cursor:hand"> --></td>
					</tr>
				</table>
				</form>
				<!-- <table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						<td colspan=2 style="padding-right:20px">&nbsp;<br>
						<form name="attachForm" method="POST" action="">
						<table border="0" cellpadding="5" cellspacing="0" width="100%"
							bgcolor="#FFFFFF" style="border: 1px solid #A0C6E5;">
							<tr bgcolor="#A0C6E5">
				...
				%>
							...
							<tr>
								<td width="20" valign="top"><img
									src="<%=request.getContextPath()%>/images/attachfile.gif"
									width="15" height="12"></td>
								<td width="80%"><%=attachFileBean.getFileOriginName()%></td>
								<td align=right nowrap></td>
								<td align="center"><input type="image" name="att0"
									src="<%=request.getContextPath()%>/images/delFile.gif"
									onclick="javascript:_delAttach('<%=index%>')"></td>
							</tr>
							<tr>
								...
								<td background="<%=request.getContextPath()%>/images/bg-13.gif"></td>
								<td height="2"
									background="<%=request.getContextPath()%>/images/bg-13.gif"></td>
							</tr>
							<%}//end for
		...
		<td width="1"
			background="<%=request.getContextPath()%>/images/bg-22.gif"><img
			src="<%=request.getContextPath()%>/images/bg-22.gif" width="1"
			height="4"></td>
	</tr>
</table>
...
<table width="75%" border="0" align="center" cellpadding="0"
	...
	<tr>
		...
		<td height="2"
			background="<%=request.getContextPath()%>/images/bg-13.gif"></td>
		<td background="<%=request.getContextPath()%>/images/bg-13.gif"
			align=right><img src="<%=request.getContextPath()%>/images/bg-22.gif"
			width="1" height="2"></td>
	</tr>
	<tr>
		<td width="1%"><img
			src="<%=request.getContextPath()%>/images/bg-21.jpg" width="10"
			height="21"></td>
		<td width="48%"
			background="<%=request.getContextPath()%>/images/bg-23.jpg"
			class="text-01">&nbsp;</td>
		<td width="49%"
			background="<%=request.getContextPath()%>/images/bg-23.jpg"
			class="text-01">
		...
		<td width="2%"
			background="<%=request.getContextPath()%>/images/bg-23.jpg">
		<div align="right"><img
			src="<%=request.getContextPath()%>/images/bg-22.jpg" width="11"
			height="21"></div>
		</td>
	</tr>
</table>
