...
String user = request.getAttribute("user")==null?"user":request.getAttribute("user").toString();
String typeid = request.getAttribute("typeid")==null?"-1":request.getAttribute("typeid").toString();
 ...
 <div align="center">
  ...
  <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td background="<%=request.getContextPath()%>/images/bbs/newbbs/bg-12.gif"  class="title-05">多媒体文件列表</td>
          ...
          <tr>
            ...
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr  bgcolor="#FFFBEF">
                ...
                <td width="15%" ><div align="center" class="title-04">名称</div></td>
                <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bbs/newbbs/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bbs/newbbs/bg-24.gif" width="2" height="2"></td>
                <td width="30%" ><div align="center" class="title-04">说明</div></td>
                <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bbs/newbbs/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bbs/newbbs/bg-24.gif" width="2" height="2"></td>
                <td width="15%" ><div align="center" class="title-04">下载链接</div></td>
                <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bbs/newbbs/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bbs/newbbs/bg-24.gif" width="2" height="2"></td>
                <td width="8%" ><div align="center" class="title-04">上载人</div></td>
                <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bbs/newbbs/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bbs/newbbs/bg-24.gif" width="2" height="2"></td>
                <td width="8%" ><div align="center" class="title-04">上载人时间</div></td>
                <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bbs/newbbs/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bbs/newbbs/bg-24.gif" width="2" height="2"></td>
                <td width="" ><div align="center" class="title-04">备注</div></td>
...
while(Iterator.hasNext()){
	MultiMsgVO vo = (MultiMsgVO)Iterator.next();
%>
              <tr>
	...
	<%}%>
                <td height="22" class="text-01"><%=showFlag %></td>
                <td  class="text-01"><div align="center">&nbsp;<%=vo.getMultiName() %></td>
                <td  class="text-01"><div align="left"> <%=vo.getMultiDesc() %>  </div></td>
                <td  class="text-01"><div align="center"><%=vo.getMultiLink() %></div></td>
                <td  class="text-01"><div align="center"><%=vo.getMultiUploaduser() %></div></td>
                <td  class="text-01"><div align="center"><%=vo.getMultiUploadtime() %></div></td>
                <td  class="text-01"><div align="center"><%=vo.getMultiMemo() %></div></td>
...
%>
  ...
  <%if("manager".equals(user.toString())){ %>
  <br>
...
<script language="JavaScript">
 function _add(){
	...
	form1.action="<%=request.getContextPath()%>/multimsg/multimsg_add.jsp?typeid=<%=typeid%>";
