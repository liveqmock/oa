...
<%  
    ...
    Long counter = new Long(0);
	 allmonth = (Long [])request.getAttribute("allmonth");
	// Long counter = (Long)request.getAttribute("counter");
	for (int i=0;i<12;i++){counter=new Long(counter.longValue()+allmonth[i].longValue());}
%>
  ...
  <tr>
      <td height="266" valign="top">
          <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <td background="<%=request.getContextPath()%>/images/bg-12.gif"  class="title-05">网站访问按年统计列表 访问总数：<%=counter%></td>  
...
%>
                <td height="22" class="text-01" align="center"><%=i+1%>月</td>
       			<td class="text-01" align="center"><%= allmonth[i]%></td>
       			<% 
       			   double userFileSize =
				CommUtil.getDivision(allmonth[i].longValue()*100, counter.longValue(), 1);
       			 %>
