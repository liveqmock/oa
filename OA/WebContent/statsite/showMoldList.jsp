  ...
  <tr>
      <td height="266" valign="top">
          ...
          <%
            ...
            <td background="<%=request.getContextPath()%>/images/bg-12.gif"  class="title-05">进入模块统计列表 访问总数：<%=count1%>     今天的时间是：<%=time1 %>     星期<%= str %></td>  
              ...
              <td width="100%"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td background="<%=request.getContextPath()%>/images/bg-09.jpg"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr  bgcolor="#FFFBEF">
                        <td width="20%" height="22" align="center" class="title-04">访问模块</td>
...
%>
                <td height="22" class="text-01" align="center"><%= vo.getVisMold()%></td>
       			<td class="text-01" align="center"><%= vo.getVisNumber()%></td>
       			<% 
       			   double userFileSize =
				CommUtil.getDivision(vo.getVisNumber().intValue()*100, count, 1);
       			 %>
