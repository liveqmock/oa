...
<HTML><HEAD><TITLE>拒绝登录交流园地</TITLE>
...
<div align="center" >
          <table width="85%"  border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td background="<%=request.getContextPath()%>/images/bg-12.gif" class="title-05">拒绝登录</td>
              ...
              <td width="100%"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="100%" height="82" class="text-01"><div align="center"><b>登录的账号为公用账号</b> 或 <b>您不是系统用户</b></div></td>
                        </tr>
                        <tr>
