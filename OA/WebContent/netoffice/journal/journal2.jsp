...
<%
  ...
  //得到设置的月份数
    ...
    String _curdate=request.getParameter("date");
        ...
        <tr>
          <td height="100%" background="<%=request.getContextPath()%>/images_new/bg-09.jpg"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            月 </td>
                        ...
                        <br>
                        <div align="left">&nbsp;&nbsp; 说明:您现在查看的是<font color=red><%=_curdate%></font>的日记</div></td>
                      </tr>
                  </table>
              </div></td>
...
<table align="center" width="98%">
  <tr>
	...
	<TD width="20%" height=54 align=left vAlign=center><A href="<%=request.getContextPath()%>/netoffice/journal/write1.jsp?_page_num=<%=_page_num%>&_curdate=<%=_curdate%>" ><img src="<%=request.getContextPath()%>/images/write_journal.gif" border="0" ></A>  </TD>
