...
memoList = (List)request.getAttribute("list");
Iterator  memoIterator=null;
memoIterator = memoList.iterator();

String selectDay = (String)request.getAttribute("date");
%>
        ...
        <tr>
          <td height="100%" background="<%=request.getContextPath()%>/images_new/bg-09.jpg"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            月 </td>
                        ...
                        <br>
                        <div align="left">&nbsp; 说明:你现在看到的是<font color=red><%=request.getAttribute("date")%></font>的备忘录</div></td>
                      </tr>
                  </table>
              </div></td>
           ...
           %>
               ...
               %>
                 <tr onMouseOver="this.bgColor='#8CC0E8';" onMouseOut="this.bgColor='#D8EAF8';" bgcolor="#D8EAF8">
					...
					<td height="22"><div align="center" class="text-01"><a href="<%=request.getContextPath()%>/servlet/ContentShowMemoServlet?mid=<%=vo.getMemoId()%>&&doChoice=update1"">·修改</a> </div></td>
                  </tr>
                  <%if(i<=7){%>
                  <tr>
            ...
            <tr>
                      <td height="2" colspan=3 background="<%=request.getContextPath()%>/images/bg-13.gif"></td>
            </tr>
...
<table align="center" width="98%">
  <tr>
    <TD width="100%" align=center vAlign=center>&nbsp;
    	<img onClick="javascript:_add('<%=request.getContextPath()%>/netoffice/memo/memoEdit.jsp?currentDay=false&selectDay=<%=selectDay%>')" src="<%=request.getContextPath()%>/images/memo.gif" border="0" style="cursor:hand">&nbsp;&nbsp;
    	<img onClick="javascript:_back('<%=request.getContextPath()%>/servlet/ShowMemoServlet')" src="<%=request.getContextPath()%>/images/botton-return.gif" border="0" style="cursor:hand">&nbsp;&nbsp;
    	<img onClick="javascript:delete1('<%=request.getContextPath()%>')"   src="<%=request.getContextPath()%>/images/delete1.gif" style="cursor:hand">&nbsp;&nbsp;
		<img onClick="javascript:_import('<%=request.getContextPath()%>')"   src="<%=request.getContextPath()%>/images/exportmemo.gif"  style="cursor:hand">
	</td>
  </tr>
</table>
