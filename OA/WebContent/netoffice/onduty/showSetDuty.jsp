              ...
              <tr>
				...
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr bgcolor="#F2F9FF">
                        ...
                        <td width="65%" bgcolor="#F2F9FF"><div><input id="dutyName" name="dutyName" size="20" class=txt2>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="修改提交" onclick="javascript:_editDutyName('<%=orgUUid%>','<%=com.icss.oa.util.CommUtil.getTime(weekStart)%>')"></div></td>
                    </tr>
                    <tr>
                        <td height="2" background="<%=request.getContextPath()%>/images/bg-13.gif"></td>
                        <td background="<%=request.getContextPath()%>/images/bg-13.gif"></td>
                    ...
                    <tr bgcolor="#F2F9FF">
                        ...
                        <td width="65%" class="text-01" bgcolor="#F2F9FF">
                            <div>
                              <input type="text" id="time1" name="time1" size="3" class="txt2">：</b>
                              <input type="text" id="time2" name="time2" size="3" class="txt2">
                    ...
                    <tr>
                        ...
                        <td class="text-01" bgcolor="#F2F9FF">
                          <div>
                              <input type="text" id="time3" name="time3" size="3" class="txt2">：</b>
                              <input type="text" id="time4" name="time4" size="3" class="txt2"> 
                          </div>
                        </td>
                    </tr>
                    <tr>
