...
<!--
	...
	//选择日期后显示
	function _ShowDuty(){
	    document.CalendarForm.action = "<%=request.getContextPath()%>/servlet/ShowDutyServlet";
...
<table width="60%"  border="0" cellpadding="0" cellspacing="0">
   ...
   <tr>
      ...
      <td width="60%">
         ...
         <A href="#" onclick="javascript:_printDuty('<%=orgUUid%>','<%=request.getAttribute("dutyName")%>')"><img src="<%=request.getContextPath()%>/netoffice/image/button-dutyprint.gif" height="19" border="0"></a>
      </td>
   </tr>
   </form>
</table><br>
