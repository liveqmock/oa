...
<%@ page import="com.icss.oa.netoffice.config.TypeConfig" %>
...
AddValue = FirstDayInWeek;
	...
	//CmdStr = "window.jForm."+RowName+WeekRow+".innerHTML = '<a href=javascript:GoToDate("+year+","+month+","+i+")>"+i+"</a>'";
		...
		CmdStr = "window."+RowName+WeekRow+".innerHTML = '<a href=\"CalendarChoiceServlet?date="+datex+"\" >"+i+"</a>'";
		eval(CmdStr);
		...
		if(today == i){
			CmdStr = "window."+RowName+WeekRow+".innerHTML = '<a href=\"CalendarChoiceServlet?date="+datex+"\" ><font color=\\\'#FF0000\\\'>"+today+"</font></a>'";
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" bgColor='#D6E7F7'>
  <tr>
    ...
    <td width="97%" background="<%=request.getContextPath()%>/images/bg-12.gif" class="title-05">日程安排</td>
        ...
        <tr>
          <td height="100%" background="<%=request.getContextPath()%>/images_new/bg-09.jpg"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            border=0>
                    <TBODY>
                      <tr>
                        <td width="78" height="61"  align="center" valign="middle"><a href="#"><img src="<%=request.getContextPath()%>/images/botton-02.gif" border=0></a></td>
                        <td width="78"  align="center" valign="middle"><a href="<%=request.getContextPath()%>/netoffice/schedule/add1.jsp" ><img 
                  				height=19 src="<%=request.getContextPath()%>/images/botton-03.gif" width=56 border=0></a></td>
                      </tr>
                    </TBODY>
                </TABLE>
                        <br>
              ...
              <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0" bgColor='#D6E7F7'>
                <tr>
                  ...
                  <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                  <td width="38%" bgcolor="#FFFBEF"><div align="center" class="title-04">日程标题</div></td>
                  <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                  <td width="18%" height="22" bgcolor="#FFFBEF"><div align="center" class="title-04">事件类型</div></td>
                  <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
                  <td width="22%" height="22" bgcolor="#FFFBEF"><div align="center" class="title-04">时间</div></td>
				  <td width="2" rowspan="100" valign="top" background="<%=request.getContextPath()%>/images/bg-24.gif"><img src="<%=request.getContextPath()%>/images/bg-24.gif" width="2" height="2"></td>
              ...
              %>
                 <tr onMouseOver="this.bgColor='#8CC0E8';" onMouseOut="this.bgColor='<%=color%>';" bgcolor=<%=color%>>
                    ...
                    <td  class="text-01"><div align="left"> <a 
                        ...
                        href="<%= request.getContextPath()%>/ContentShowServlet?jid=<%=vo.getOsId()%>&&doChoice=content">&nbsp;<%=vo.getOsTopic()%></a> </div></td>
                    <td height="22"><div align="center" class="text-01">
                      <%if(type_task.equals(TypeConfig.SCHEDULE_TASK_ALLDAY)){%>全天事件
                      <%}
                      else{
                      %>
                      定时事件
					...
					<td height="22"><div align="center" class="text-01"><a href="<%=request.getContextPath()%>/ContentShowServlet?jid=<%//=vo.getRjId()%>&&doChoice=update1&&_page_num=<%=_page_num%>"">·修改</a> </div></td>
                  </tr>
                  <tr>
...
<table align="center" width="98%">
  <tr>
    <TD width="35%" height=54 align=right vAlign=center> <img src="<%=request.getContextPath()%>/images/botton-return.gif" onclick="location.href='javascript:history.go(-1)'" style="cursor:hand"></TD>
    <TD width="8%" align=right vAlign=center>&nbsp;</TD>
    <td width="35%" align="">
	  <img  onClick="javascript:delete1('<%=request.getContextPath()%>')"    src="<%=request.getContextPath()%>/images/delete1.gif">
	</td>
  </tr>
</table>
