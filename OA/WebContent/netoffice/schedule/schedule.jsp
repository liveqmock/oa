...
{
	  if(_check("没有可删除的对象","请至少选择一个要删除的日程安排"	)){
...
function _export(url){
    if(_check("没有可导出的日程安排","请选择至少一个要导出的日程安排！")){
            ...
            border=0>
                    <TBODY>
                      <tr>
                        ...
                        <br>
                        <div align="left">&nbsp;&nbsp; 说明:此系统已设置为保留<%=months%>个月内的日程</div></td>
                      </tr>
                  </table>
              </div></td>
            ...
            <% 
              ...
              %>
                 <tr onMouseOver="this.bgColor='#8CC0E8';" onMouseOut="this.bgColor='<%=color%>';" bgcolor=<%=color%>>
					...
					<td height="22"><div align="center" class="text-01"><a href="<%=request.getContextPath()%>/servlet/ContentShowScheduleServlet?sid=<%=vo.getOsId()%>&doChoice=update1&_page_num=<%=_page_num%>&date_sel=<%=datey%>">·修改</a> </div></td>
                  </tr>
                  <tr>
