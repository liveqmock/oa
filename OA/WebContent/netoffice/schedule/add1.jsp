      ...
      <table width="100%"  border="0" align="center" cellpadding="1" cellspacing="0">
        <tr>
          <td valign=top nowrap width="49%" bgcolor="#D8EAF8">名　称：
              <input name="headline" type=text class=form value='' size=30 maxlength=80>
          </td>
        ...
        <tr bgcolor=#EEF4FF>
          <td bgcolor="#D8EAF8">地　点：
              <input type="text" name="place" class=form size="30" value=''>
          </td>
        ...
        <tr>
          ...
          <td valign=top nowrap rowspan="2" width="51%" bgcolor="#D8EAF8"> 备　注：<br>
              <textarea name=notes class=textarea wrap=virtual rows=6 cols=30></textarea>
          </td>
        </tr>
        <tr>
...
<p align="center">
<a href="#"  onClick="Check_values('<%=request.getContextPath()%>')">
    <img  src="<%=request.getContextPath()%>/images/botton-ok.gif" width="70" height="22" hspace="10" border=0></a>
    <img  src="<%=request.getContextPath()%>/images/botton-return.gif" width="70" height="22" hspace="10" onclick="location.href='javascript:history.go(-1)'" style="cursor:hand"></p>
</form>
<script language=javascript>
<!-- 
