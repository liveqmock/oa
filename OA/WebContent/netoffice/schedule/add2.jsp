...
<%
   String datesel=request.getParameter("date_sel");
   long date1=CommUtil.getLongByTime(datesel);
...
<script language=javascript>
  //var a=document.Compose.date_sel.value;
  //alert(a);
</script>
<%
